...
var resolveFetch = (customFetch) => {
  ...
  if (customFetch) {
    ...
    _fetch = (...args) => import("./browser-575MNK6W.js").then(({
      default: fetch2
    }) => fetch2(...args));
  } else {
    _fetch = fetch;
...
var DEFAULT_HEADERS2 = {
  "X-Client-Info": `realtime-js/${version2}`
};
var VSN = "1.0.0";
...
var RealtimeClient = class {
  ...
  connect() {
    ...
    import("./browser-P3JLQAFT.js").then(({
      default: WS
    }) => {
...
var resolveResponse = () => __awaiter2(void 0, void 0, void 0, function* () {
  if (typeof Response === "undefined") {
    return (yield import("./browser-575MNK6W.js")).Response;
  }
  return Response;
});
...
var DEFAULT_HEADERS5 = {
  "X-Client-Info": `gotrue-js/${version5}`
};
